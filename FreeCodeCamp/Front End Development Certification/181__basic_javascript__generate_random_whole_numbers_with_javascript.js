 ...
 *
 *	Use another function, Math.floor() to round the number down to its
 *	nearest whole number.
 *
 * Remember that Math.random() can never quite return a 1 and, because we're
 * rounding down, it's impossible to actually get 20. This technique will
 ...
 *
 * We are calling Math.random(), multiplying the result by 20, then passing
 * the value to Math.floor() function to round the value down to the nearest
 * whole number.
 *
 * Instructions
 *
