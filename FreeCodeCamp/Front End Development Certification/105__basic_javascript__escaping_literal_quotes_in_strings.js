 ...
 * double quote. What happens when you need a literal quote: " or ' inside of
 * your string?
 *
 ...
 * string, but should instead appear inside the string. So if you were to
 * print this to the console, you would get:
 *
