/*
 * In the casino game Blackjack, a player can gain an advantage over the
 * house by keeping track of the relative number of high and low cards
 ...
 * card's value (see table). The function will then return a string with the
 * current count and the string "Bet" if the count is positive, or "Hold" if
 * the count is zero or negative. The current count and the player's
