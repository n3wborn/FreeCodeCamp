 ...
 * statement tests a value and can have many case statements which defines
 * various possible values. Statements are executed from the first matched
 ...
 * JavaScript to stop executing statements. If the break is omitted, the
