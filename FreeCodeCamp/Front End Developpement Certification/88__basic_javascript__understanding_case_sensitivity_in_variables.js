 ...
 * means that capitalization matters.
 *
 ...
 * recommended that for the sake of clarity, you do not use this language
 * feature.
 *
 * Best Practice
 *
 * Write variable names in Javascript in camelCase. In camelCase, multi-word
 * variable names have the first word in lowercase and the first letter of
 ...
 * Instructions
 *
 * Modify the existing declarations and assignments so their names use
 * camelCase.
